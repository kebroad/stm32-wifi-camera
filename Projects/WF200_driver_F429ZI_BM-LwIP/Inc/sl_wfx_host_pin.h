...
/* SPI IRQ pin: PD15 */
#define SL_WFX_IRQ_PORT_SPI        GPIOD  //yellow
#define SL_WFX_IRQ_GPIO_SPI        GPIO_PIN_15
/* WIRQ pin: PF12 */
#define SL_WFX_WIRQ_PORT           GPIOF //blue
#define SL_WFX_WIRQ_GPIO           GPIO_PIN_12
/* Reset pin: PF13 */
#define SL_WFX_RESET_PORT          GPIOF //white
#define SL_WFX_RESET_GPIO          GPIO_PIN_13
/* Wake-up pin: PE9 */
#define SL_WFX_WUP_PORT            GPIOE //purple
